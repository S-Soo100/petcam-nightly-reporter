...
GME_ANALYSIS_FPS = min(max(float(os.environ.get("GME_ANALYSIS_FPS", "10")), 1.0), 30.0)
GME_ANCHOR_INTERVAL_SEC = float(os.environ.get("GME_ANCHOR_INTERVAL_SEC", "0.1"))
...
GME_DETECTOR_FREEZE_SHA256 = os.environ.get("GME_DETECTOR_FREEZE_SHA256", "")
GME_DETECTOR_IDENTITY = os.environ.get("GME_DETECTOR_IDENTITY", "")
GME_ALGORITHM_VERSION = os.environ.get("GME_ALGORITHM_VERSION", "gme-motion-v1")
GME_MODEL_VERSION = os.environ.get("GME_MODEL_VERSION", "v2.6-warm-start-s28")
GME_RAW_CONFIDENCE = float(os.environ.get("GME_RAW_CONFIDENCE", "0.001"))
GME_SCORE_THRESHOLD = float(os.environ.get("GME_SCORE_THRESHOLD", "0.15"))
GME_IMAGE_SIZE = int(os.environ.get("GME_IMAGE_SIZE", "960"))
GME_NMS_IOU = float(os.environ.get("GME_NMS_IOU", "0.70"))
GME_POST_NMS_IOU = float(os.environ.get("GME_POST_NMS_IOU", "0.55"))
GME_MAX_DETECTIONS = int(os.environ.get("GME_MAX_DETECTIONS", "50"))
GME_TEMPORAL_WINDOW_FRAMES = int(os.environ.get("GME_TEMPORAL_WINDOW_FRAMES", "5"))
GME_TEMPORAL_MIN_POSITIVE_FRAMES = int(os.environ.get("GME_TEMPORAL_MIN_POSITIVE_FRAMES", "3"))
